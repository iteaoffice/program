...
return [
    ...
    'program/session-manager/list'              => __DIR__ . '//view/program/session-manager/list.twig',
    'program/session-manager/tab/participants'  => __DIR__ . '//view/program/session-manager/tab/participants.twig',
    'program/session-manager/tab/files'         => __DIR__ . '//view/program/session-manager/tab/files.twig',
    'program/session-manager/tab/presentations' => __DIR__ . '//view/program/session-manager/tab/presentations.twig',
    'program/session-manager/edit-participants' => __DIR__ . '//view/program/session-manager/edit-participants.twig',
    'program/session-manager/edit'              => __DIR__ . '//view/program/session-manager/edit.twig',
    ...
    'program/call-manager/tab/projects'         => __DIR__ . '//view/program/call-manager/tab/projects.twig',
    'program/call-manager/tab/general'          => __DIR__ . '//view/program/call-manager/tab/general.twig',
    'program/call-manager/tab/countries'        => __DIR__ . '//view/program/call-manager/tab/countries.twig',
    'program/call-manager/tab/sessions'         => __DIR__ . '//view/program/call-manager/tab/sessions.twig',
