    ...
    'bjyauthorize' => [
        'guards' => [
            ...
            Route::class => [
                ...
                ['route' => 'zfcadmin/session/download', 'roles' => [Access::ACCESS_OFFICE]],
                ['route' => 'zfcadmin/session/upload-document', 'roles' => [Access::ACCESS_OFFICE]],
                ['route' => 'zfcadmin/session/idea-files', 'roles' => [Access::ACCESS_OFFICE]],
                ...
                ['route' => 'community/program/session/download-document', 'roles' => [strtolower(Access::ACCESS_USER)]],
